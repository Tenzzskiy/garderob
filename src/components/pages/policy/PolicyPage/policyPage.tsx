	...
	return (
		<section className={styles.section}>
			<div className='container'>
				<h1 className={styles.title}>Политика по обработке и защите персональных данных</h1>
				...
				<p className={styles.text}>
					...
					персональных данных, предпринимаемые Выездной Гардероб 77 (далее – Оператор).
				</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://vyezdnoy-garderob77.ru.
				</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					определяемому Пользователю веб-сайта https://vyezdnoy-garderob77.ru.
				</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>2.10. Пользователь – любой посетитель веб-сайта https://vyezdnoy-garderob77.ru.</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					документы, содержащие персональные данные; – в случае отзыва субъектом персональных данных согласия
					на обработку персональных данных Оператор вправе продолжить обработку персональных данных без
					согласия субъекта персональных данных при наличии оснований, указанных в Законе о персональных
				...
				<p className={styles.text}>
					...
					данных; – сообщать в уполномоченный орган по защите прав субъектов персональных данных по запросу
					этого органа необходимую информацию в течение 30 дней с даты получения такого запроса; – публиковать
					или иным образом обеспечивать неограниченный доступ к настоящей Политике в отношении обработки
				...
				<p className={styles.subtitle}>4. Основные права и обязанности субъектов персональных данных</p>
				<p className={styles.text}>
					...
					информации и порядок ее получения установлен Законом о персональных данных; – требовать от оператора
					...
					своих прав; – выдвигать условие предварительного согласия при обработке персональных данных в целях
					продвижения на рынке товаров, работ и услуг; – на отзыв согласия на обработку персональных данных; –
				...
				<p className={styles.text}>5.1. Фамилия, имя, отчество.</p>
				<p className={styles.text}>5.2. Электронный адрес.</p>
				<p className={styles.text}>5.3. Номера телефонов.</p>
				<p className={styles.text}>
				...
				<p className={styles.subtitle}>6. Принципы обработки персональных данных</p>
				<p className={styles.text}>
				...
				<p className={styles.subtitle}>7. Цели обработки персональных данных</p>
				<p className={styles.text}>
					7.1. Цель обработки персональных данных Пользователя: – информирование Пользователя посредством
					...
					веб-сайте https://fotozona77.ru; – уточнение деталей заказа.
				</p>
				<p className={styles.text}>
					...
					info@vyezdnoy-garderob77.ru с пометкой «Отказ от уведомлений о новых продуктах и услугах и специальных
					предложениях».
				</p>
				<p className={styles.text}>
				...
				<p className={styles.subtitle}>8. Правовые основания обработки персональных данных</p>
				<p className={styles.text}>
					8.1. Правовыми основаниями обработки персональных данных Оператором являются: – перечислите
					нормативно-правовые акты, регулирующие отношения, связанные с вашей деятельностью, например, если
					ваша деятельность связана с информационными технологиями, в частности с созданием сайтов, то здесь
					можно указать Федеральный закон "Об информации, информационных технологиях и о защите информации" от
					27.07.2006 N 149-ФЗ; – уставные документы Оператора; – договоры, заключаемые между оператором и
					субъектом персональных данных; – федеральные законы, иные нормативно-правовые акты в сфере защиты
				...
				<p className={styles.text}>
					...
					https://vyezdnoy-garderob77.ru или направленные Оператору посредством электронной почты. Заполняя
				...
				<p className={styles.subtitle}>9. Условия обработки персональных данных</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					info@vyezdnoy-garderob77.ru с пометкой «Актуализация персональных данных».
				</p>
				<p className={styles.text}>
					...
					info@vyezdnoy-garderob77.ru с пометкой «Отзыв согласия на обработку персональных данных».
				</p>
				<p className={styles.text}>
				...
				<p className={styles.subtitle}>12. Трансграничная передача персональных данных</p>
				<p className={styles.text}>
				...
				<p className={styles.subtitle}>13. Конфиденциальность персональных данных</p>
				<p className={styles.text}>
				...
				<p className={styles.subtitle}>14. Заключительные положения</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					https://vyezdnoy-garderob77.ru/policy.
				</p>
			</div>
		</section>
	);
