		...
		<section className={styles.section}>
			<div className='container'>
				...
				<p className={styles.text}>
					...
					персональных данных, предпринимаемые Фотозона 77 (далее – Оператор).
				</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://fotozona77.ru.
				</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					определяемому Пользователю веб-сайта https://fotozona77.ru.
				</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>2.10. Пользователь – любой посетитель веб-сайта https://fotozona77.ru.</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					info@polevaya-kuhnya77.ru с пометкой «Отказ от уведомлений о новых продуктах и услугах и специальных
					предложениях».
				</p>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					https://fotozona77.ru или направленные Оператору посредством электронной почты. Заполняя
				...
				<p className={styles.text}>
					...
					info@polevaya-kuhnya77.ru с пометкой «Актуализация персональных данных».
				</p>
				<p className={styles.text}>
					...
					info@polevaya-kuhnya77.ru с пометкой «Отзыв согласия на обработку персональных данных».
				</p>
				<p className={styles.text}>
